...
#         post :create, {:trainer => invalid_attributes}, valid_session
#         expect(assigns(:trainer)).to be_a_new(Trainer)
#       end
...
#         trainer = Trainer.create! valid_attributes
#         put :update, {:id => trainer.to_param, :trainer => new_attributes}, valid_session
#         trainer.reload
...
#         trainer = Trainer.create! valid_attributes
#         put :update, {:id => trainer.to_param, :trainer => invalid_attributes}, valid_session
#         expect(assigns(:trainer)).to eq(trainer)
#       end
